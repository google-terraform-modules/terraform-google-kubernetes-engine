...
variable "default_node_pool_additional_zones" {
  type        = "list"
  default     = []
  description = "The list of additional Google Compute Engine locations in which the cluster's nodes should be located. If additional zones are configured, the number of nodes specified in default_node_pool[node_count] is created in all specified zones"
}
